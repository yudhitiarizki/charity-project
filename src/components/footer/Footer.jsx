          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mx-auto">
              ...
              <p class="text-white d-flex mb-2">
                ...
                <div class="site-footer-link">0819823988 </div>
              </p>

              <p class="text-white d-flex">
                <i class="bi-envelope me-2"></i>

                <div class="site-footer-link">donate@sparta.id</div>
              </p>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-7 col-12">
                <p class="copyright-text mb-0">
                  Copyright © 2022 <a>Kind Heart</a> Charity <a href="https://templatemo.com" target="_blank"></a>
                </p>
              </div>
